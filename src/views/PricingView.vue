<script setup>
import Customizable from '@/components/autentication/features/Customizable.vue';
import Fortune from '@/components/autentication/features/Fortune.vue';
import Documentation from '@/components/autentication/features/Documentation.vue';
import FeatureList from '../components/autentication/features/FeatureList.vue';
</script>
                        ...
                        <div class="grid grid-cols-1 gap-12 md:grid-cols-2">
                            ...
                            <div>
                                <div class="p-8 border rounded-3xl">
                                    ...
                                    <RouterLink to="/success"
                                        class="inline-flex items-center justify-center w-full px-8 py-3 text-base font-medium text-white bg-indigo-700 border border-transparent rounded-full hover:bg-indigo-700 md:py-2 md:text-md md:px-10 hover:shadow">
                                        Checkout Now
                                    </RouterLink>
                                </div>
                            </div>
